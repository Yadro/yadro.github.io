...
define(["require", "exports", 'react', '../../node_modules/fraction.js/fraction', "../helper/matrix", '../helper/tools', "../helper/fileLoad"], function (require, exports, React, Fraction, matrix_1, tools_1, fileLoad_1) {
    ...
    var InputMatrix = (function (_super) {
        ...
        InputMatrix.prototype.render = function () {
            ...
            return (React.createElement("div", null, React.createElement("button", {onClick: this.saveToJson.bind(this)}, "download"), React.createElement("div", null, React.createElement("label", null, "Число коэффициентов полинома:"), React.createElement("input", {type: "text", value: this.state.width, onChange: this.setSize.bind(this, 'width')})), React.createElement("div", null, React.createElement("label", null, "Число граничных условий:"), React.createElement("input", {type: "text", value: this.state.height, onChange: this.setSize.bind(this, 'height')})), React.createElement("div", null, React.createElement("span", null, "Полином:"), this.rowPoly()), React.createElement("div", null, React.createElement("span", null, "Граничные условия:"), matrixComp), this.state.errorMsg.length !== 0 ?
